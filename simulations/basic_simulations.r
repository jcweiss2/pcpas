### simulation 1. single event, periodic. Future: {periodic, quasiperiodic, quasiperiodic with missingness, scheduled but aperiodic, quasischeduled but aperiodic};
...
outputAForest = learn_pc(forest,dats, "A",iter=10)
...
plot_pt_rate_graph(dats,outputAForest,2) 
plot_pt_rate_graph(dats,output,2) 